...
| **agentkube-mini** |A task DAG, dependency-aware parallel scheduler, and event system for multi-agent pipelines - all in about 400 lines | [`pip install multi-agent-generator`](https://pypi.org/project/multi-agent-generator/) | [![PyPI Downloads](https://static.pepy.tech/personalized-badge/agentkube-mini?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/agentkube-mini)| Creator |
